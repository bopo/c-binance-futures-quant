...
def record_position():
    ...
    if now - UPDATE_TS > 60:
        ...
        insertSQLStr = "('all','" + str(allUnrealizedProfit) + "','" + str(allPositionAmt) + "','" + str(now) + "','" + str(FUNCTION_CLIENT.turn_ts_to_time(now)) + "','" + str(
            allPositionValue) + "','" + str(ACCOUNT_BALANCE_VALUE) + "')"

from .constant.system import RestApiDefine
from .impl.restapiinvoker import call_sync
from .impl.restapirequestimpl import RestApiRequestImpl
...
class RequestClient(object):
    ...
    def post_market_order(self, symbol: 'str', side: 'OrderSide', ordertype: 'OrderType',
        ...
        response = call_sync(self.request_impl.post_market_order(symbol, side, ordertype,
                                                                 timeInForce, quantity, reduceOnly, price, newClientOrderId, stopPrice, workingType, closePosition, positionSide,
    ...
    def post_auto_order_with_price(self, symbol: 'str', side: 'OrderSide', ordertype: 'OrderType',
        ...
        response = call_sync(self.request_impl.post_auto_order_with_price(symbol, side, ordertype,
                                                                          timeInForce, quantity, reduceOnly, price, newClientOrderId, stopPrice, workingType, closePosition,
                                                                          positionSide, callbackRate, activationPrice, newOrderRespType))

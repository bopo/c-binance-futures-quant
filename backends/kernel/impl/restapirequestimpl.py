# For develop
from backends.kernel.base.printobject import *
from backends.kernel.impl import RestApiRequest
from backends.kernel.impl.utils.apisignature import create_signature
from backends.kernel.impl.utils.inputchecker import *
from backends.kernel.impl.utils.timeservice import *
from backends.kernel.impl.utils.urlparamsbuilder import UrlParamsBuilder
from backends.kernel.model import *
...
class RestApiRequestImpl(object):
    ...
    def post_auto_order_with_price(self, symbol, side, ordertype,
                                   timeInForce, quantity, reduceOnly, price, newClientOrderId, stopPrice, workingType, closePosition, positionSide, callbackRate, activationPrice,
                                   newOrderRespType):
        request = RestApiRequest()
        request.method = 'POST'
        request.host = self.__server_url
        ...
        if not reduceOnly:
            reduceOnlyStr = 'false'
        extraUrl = 'newClientOrderId=' + newClientOrderId + '&price=' + str(
            price) + '&symbol=' + symbol + '&side=' + side + '&type=' + ordertype + '&timeInForce=' + timeInForce + '&quantity=' + str(
            quantity) + '&reduceOnly=' + reduceOnlyStr + '&stopPrice=' + str(stopPrice) + '&positionSide=' + positionSide + '&recvWindow=60000&timestamp=' + ts + ''
    ...
    def post_auto_order(self, symbol, side, ordertype,
        ...
        if not reduceOnly:
            reduceOnlyStr = 'false'
        extraUrl = 'newClientOrderId=' + newClientOrderId + '&symbol=' + symbol + '&side=' + side + '&type=' + ordertype + '&timeInForce=' + timeInForce + '&quantity=' + str(
            quantity) + '&reduceOnly=' + reduceOnlyStr + '&stopPrice=' + str(
            stopPrice) + '&positionSide=' + positionSide + '&workingType=CONTRACT_PRICE&recvWindow=60000&timestamp=' + ts + ''
    ...
    def post_order(self, symbol, side, ordertype,
        ...
        if not reduceOnly:
            reduceOnlyStr = 'false'
        extraUrl = 'newClientOrderId=' + newClientOrderId + '&symbol=' + symbol + '&side=' + side + '&type=' + ordertype + '&timeInForce=' + timeInForce + '&quantity=' + str(
            quantity) + '&reduceOnly=' + reduceOnlyStr + '&price=' + str(price) + '&positionSide=' + positionSide + '&recvWindow=60000&timestamp=' + ts + ''
    ...
    def post_market_order(self, symbol, side, ordertype,
        ...
        if not reduceOnly:
            reduceOnlyStr = 'false'
        extraUrl = 'symbol=' + symbol + '&side=' + side + '&type=' + ordertype + '&quantity=' + str(
            quantity) + '&reduceOnly=' + reduceOnlyStr + '&positionSide=' + positionSide + '&recvWindow=60000&timestamp=' + ts + ''
